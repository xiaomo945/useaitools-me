...
const MysteryBoxModal: React.FC<MysteryBoxModalProps> = ({
  ...
  if (!show || !mysteryTool) return null;
  ...
  return (
    <>
      ...
      <div className="fixed inset-0 z-50 flex items-center justify-center p-4 pointer-events-none">
        <div className="bg-white dark:bg-gray-900 rounded-3xl shadow-2xl border border-slate-200 dark:border-gray-800 max-w-md w-full overflow-hidden pointer-events-auto animate-fade-in-up">
          {!mysteryRevealed ? (
            <div className="p-6 sm:p-8 text-center">
              ...
              <div className="space-y-3 mb-8">
                {mysteryHints.map((hint, i) => (
                  <div key={i} className="flex items-center gap-3 px-4 py-3 bg-amber-50 dark:bg-amber-900/30 rounded-xl text-left">
