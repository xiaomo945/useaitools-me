...
type Tool = {
  ...
  name: string;
  description: string;
  category: 'Writing' | 'Image' | 'Productivity' | 'Code' | 'Audio' | 'Video' | 'Medical' | 'Finance' | 'Law' | 'Agriculture' | 'Transportation' | 'Logistics' | 'Energy' | 'Environment' | 'Government' | 'Travel' | 'Manufacturing' | 'Retail';
  url: string;
