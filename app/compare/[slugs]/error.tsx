  ...
  return (
    <div className="min-h-[60vh] flex flex-col items-center justify-center px-4">
      <div className="max-w-md w-full text-center">
        ...
        <h2 className="text-2xl font-bold text-slate-900 dark:text-gray-100 mb-2">Comparison not available</h2>
        <p className="text-slate-600 dark:text-gray-400 mb-6">
          We couldn't load this comparison. Please check the tools and try again.
        </p>
